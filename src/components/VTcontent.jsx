...
function VTcontent({ title, taskdescr, index, data, activeTabId }) {
  ...
  return (
    <div
      key={index}
      className="section__Tasks-styledContent"
      style={activeTabId === index ? { display: "block" } : { display: "none" }}
    >
      <p className="section__Tasks-detail">{data}</p>
